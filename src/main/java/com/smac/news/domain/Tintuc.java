...
public class Tintuc implements Serializable {
    ...
    public Tintuc tieuDe(String tieuDe) {
        this.tieuDe = tieuDe;
        return this;
    }
    ...
    public Tintuc imageThumbnail(String imageThumbnail) {
    ...
    public Tintuc thoiGianDang(String thoiGianDang) {
    ...
    public Tintuc noiDungTomTat(String noiDungTomTat) {
    ...
    public Tintuc noiDungDayDu(String noiDungDayDu) {
    ...
    public Tintuc tacGia(String tacGia) {
        this.tacGia = tacGia;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Tintuc)) {
            return false;
        }
        return id != null && id.equals(((Tintuc) o).id);
    }
